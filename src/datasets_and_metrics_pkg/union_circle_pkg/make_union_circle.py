...
def make_union_circle(num_samples, x0=2, offset=False):
    samples_half = make_circle(num_samples, -x0, 0, offset=offset)
    samples_half_2 = make_circle(num_samples, x0, 0, offset=offset)
