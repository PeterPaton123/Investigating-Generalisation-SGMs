...
def distance_simple_circle(reserved_train_data, generated_samples):
    """
    ...
    return (wasserstein_distance(u_values=reserved_angles, v_values=generated_angles), wasserstein_distance(u_values=reserved_radii, v_values=generated_radii))
