...
def run_experiment(num_samples, rng):
    ...
    # Train with score matching
        ...
        plot_score(score=trained_score, t=0.01, area_min=-4, area_max=4, fname=f"bin/{num_samples}/trained_score_epoch_{1000*(i+1)}.png")
        ...
        plot_heatmap(samples=q_samples[:, [0, 1]], area_min=-4, area_max=4, fname=f"bin/{num_samples}/heatmap_trained_score_{1000*(i+1)}.png")
